...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        if "encoder_outputs" not in model_kwargs:
            ...
            # print("_prepare_encoder_decoder_kwargs_for_generation input_ids", input_ids)
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        if is_encoder_decoder:
            ...
            if 'nbs_hidden_states_list' in encoder_outputs and len(encoder_outputs['nbs_hidden_states_list']):

                model_kwargs["nbs_atmsk"] = [each_nb_msk for each_nb_msk in model_kwargs["nbs_atmsk"]]
                for nb_id, nb_hid  in enumerate(encoder_outputs['nbs_hidden_states_list']):
                    encoder_outputs["nbs_hidden_states_list"][nb_id]=nb_hid.index_select(
                        0, expanded_return_idx.to(nb_hid.device)
                    )
                    model_kwargs["nbs_atmsk"][nb_id] = model_kwargs["nbs_atmsk"][nb_id].index_select(
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        # print("generate() model_kwargs", model_kwargs)
